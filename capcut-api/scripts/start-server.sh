...
echo "  http://localhost:$PORT/login     - Login form (paste cookies here)  ← WAJIB dulu"
...
echo "  http://localhost:$PORT/render    - Render via browser editor (PRIMARY, stabil)"
echo "  http://localhost:$PORT/render-direct - Render via pure API (experimental)"
echo ""
echo "Quick start:"
echo "  1. Buka /login → paste cookies dari CapCut yang sudah login"
echo "  2. POST /render dengan template + images"
echo ""
